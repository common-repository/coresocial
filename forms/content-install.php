    ...
    <div class="d4p-setup-wrapper">
        <div class="d4p-update-info">
            ...
            <div class="d4p-install-block">
                ...
                <div>
					<?php esc_html_e( 'Installation completed.', 'coresocial' ); ?>
                </div>
            </div>

            <div class="d4p-install-confirm">
                <a class="button-primary" href="<?php echo esc_url( panel()->a()->panel_url( 'about' ) ); ?>&install"><?php esc_html_e( 'Click here to continue', 'coresocial' ); ?></a>
            </div>
        </div>
		<?php echo coresocial()->recommend( 'install' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
    </div>
</div>
